...
**Project Link:**<a href="https://github.com/dilruu89/Kaggle/blob/main/01-customer-segmentation-bank-transactions.ipynb" target="_blank">Customer Segmentation Jupyter Notebook</a>
...
In the initial phase, I applied various data analysis methods and visualization techniques. Subsequently, I conducted an Exploratory Data Analysis (EDA), selected relevant features, reduced dimensions, built and chose models, and evaluated them. This comprehensive process led to the final cluster results. Following are the techniques that I mainly used in this project.
